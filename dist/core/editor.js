...
function multipleEditors(ls, empty, ed, includeSearch = false, searchFxn = (s, x) => true, maxEntries = 30) {
    var children = [];
    var includedInds = [];
    var editor = {
        element: document.createElement("div"),
